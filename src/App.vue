  ...
  <div class="min-h-screen bg-white">
    ...
    <footer class="bg-gradient-to-b from-white to-gray-50 border-t border-gray-100 mt-16">
      ...
      <div class="relative h-12 overflow-hidden">
        <svg class="absolute bottom-0 w-full text-gray-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none" style="height: 100%; width: 100%;">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            ...
            <div class="md:col-span-1">
              ...
              <div class="flex space-x-4">
                <a href="#" class="text-gray-400 hover:text-gray-700 transition-colors duration-200">
            ...
            <!-- Quick Links -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 tracking-wider uppercase mb-4">Tools</h3>
              <ul class="space-y-3">
                <li>
                  <router-link to="/tax-calculator" class="text-gray-600 hover:text-green-600 transition-colors duration-200">
                    Tax Calculator
                  </router-link>
                </li>
                <li>
                  <router-link to="/billing" class="text-gray-600 hover:text-green-600 transition-colors duration-200">
                    Billing Generator
                  </router-link>
                </li>
                <li>
                  <router-link to="/billing-planner" class="text-gray-600 hover:text-green-600 transition-colors duration-200">
                    Billing Planner
                  </router-link>
                </li>
                <li>
                  <router-link to="/examples" class="text-gray-600 hover:text-green-600 transition-colors duration-200">
                    Success Stories
                  </router-link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul class="space-y-3">
                <li>
                  <router-link to="/tax-guide" class="text-gray-600 hover:text-green-600 transition-colors duration-200">
                    Tax Guide
                  </router-link>
                </li>
                <li>
                  <router-link to="/blog" class="text-gray-600 hover:text-green-600 transition-colors duration-200">
            ...
            <!-- Contact -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 tracking-wider uppercase mb-4">Contact Us</h3>
              <div class="space-y-3">
