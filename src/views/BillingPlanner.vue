<template>
  <div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
      <h2 class="text-2xl font-bold mb-6">Billing Planner for Creatives</h2>
        ...
        <div class="flex border-b border-gray-200">
          <button 
            ...
            :class="[
              ...
              currentStep === index ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500 hover:text-gray-700'
            ]"
          >
            {{ index + 1 }}. {{ step.name }}
          </button>
      ...
      <div v-if="currentStep === 4" class="space-y-6">
        ...
        <div class="bg-gray-50 p-4 rounded-md border border-gray-200 mb-6">
          <h4 class="text-md font-medium text-gray-900 mb-3">Project Total</h4>
          ...
          <div class="space-y-2">
            ...
            <div class="flex justify-between pt-2 border-t border-gray-300">
              ...
              <span class="font-bold text-lg">{{ formatCurrency(pricingCalculation.total) }}</span>
            </div>
          </div>
        </div>
        ...
        <!-- Project Notes -->
        <div class="mb-6">
          <label class="block text-sm font-medium text-gray-700 mb-2">Project Notes (Optional)</label>
          <textarea v-model="project.notes" rows="3" class="w-full rounded-md border-gray-300" placeholder="Any additional notes or context for this project"></textarea>
        </div>
        
        <!-- Document Generation -->
        <div class="bg-blue-50 p-4 rounded-md border border-blue-200 mb-6">
          <h4 class="text-md font-medium text-gray-900 mb-3">Document Generation</h4>
...
.bg-primary-dark {
  background-color: #1d4ed8;  /* bg-blue-700 equivalent */
}
</style>