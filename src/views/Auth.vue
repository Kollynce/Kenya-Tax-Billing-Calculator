    ...
    <div class="max-w-md w-full space-y-8 bg-white rounded-xl shadow-2xl p-6 sm:p-8">
      ...
      <div>
        <h2 class="text-center text-3xl font-extrabold text-gray-900">
          {{ isRegistering ? 'Join SanaaPesa' : 'Welcome to SanaaPesa' }}
        </h2>
        <p class="mt-2 text-center text-sm text-gray-600">
          {{ isRegistering ? 'Create your account to get started with SanaaPesa' : 'Sign in to manage your finances with SanaaPesa' }}
        </p>
      </div>
